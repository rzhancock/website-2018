    ...
    return ( 
          <div className="battle-wrapper">
            ...
            <p className="battle-description">This app was completed as part of the <a href="https://tylermcginnis.com/courses/react-fundamentals/" target="_blank"> React Fundamentals </a> course by 
              ...
              . It provided an excellent introduction to React.js, AJAX with Axios, Webpack, Babel, React Router v4, and Flexbox.
            </p>
            <p className="battle-demo">
            <a href="https://roberthancock.net/github-battle" target="_blank">Live Demo</a> | <a href ="https://github.com/rzhancock/github-battle">GitHub</a>
            </p>
