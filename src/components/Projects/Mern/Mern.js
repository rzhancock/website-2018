    ...
    return ( 
          <div className="mern-wrapper">
            ...
            <p className="mern-description">
              A simple peristent shopping list created as part of the<a href="https://www.youtube.com/playlist?list=PLillGF-RfqbbiTGgA77tGO426V3hRF9iE"> LEARN the MERN Stack </a>series by <a href="http://www.traversymedia.com/#about"> Brad Traversy</a>. This project utilizes the Express API with a MongoDB database hosted by mLab for the backend with React, Redux, Bootstrap 4, and the react-transition-group Node module on the front end. 
            </p>
            <p className="mern-demo">
            <a href="http://mern.roberthancock.net" target="_blank">Live Demo</a> | <a href ="https://github.com/rzhancock/mern_tutorial">GitHub</a>
            </p>
